                            ...
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-text-field v-model="searchForm.editNik" label="" single-line small clearable>
                                        </v-text-field>
                                    </v-col>
                                </v-row>
                            </v-col>
                            ...
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-text-field v-model="searchForm.editBirthPlace" label="Search By BirthPlace"
                                            single-line small clearable>
                                        </v-text-field>
                            ...
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-autocomplete v-model="searchForm.editReligion" :items="religion" single-line
                                            item-text="text" item-value="value" label="Religion">
                                        </v-autocomplete>
                    ...
                    <v-row no-gutters>
                        ...
                        <v-col sm="5" md="6">
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        <v-text-field v-model="searchForm.editAddress" label="Address" single-line small
                                            clearable>
                                        </v-text-field>
                            ...
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-autocomplete v-model="searchForm.editBankName" :items="bankList" single-line
                                            item-text="bank_name" item-value="bank_id" label="">
                                        </v-autocomplete>
                            ...
                            <v-col class="pa-2" outlined tile>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-text-field v-model="searchForm.editBankAccHolder" label="Bank Acc. Holder"
                                            single-line small clearable>
                                        </v-text-field>
                        ...
                        <v-col sm="5" md="6">
                            <v-col class="pa-2" outlined tile>
                                ...
                                clearable>
                                        ...
                                        <v-autocomplete v-model="searchForm.editCurrKabupaten" :disabled="curr_dis_kab"
                                            single-line :items="currkabupatenList" item-text="kabupaten"
                                            item-value="kabupaten" @change="(event) => getWilayah('currkecamatan')"
                                            label="">
                                        </v-autocomplete>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-autocomplete v-model="searchForm.editCurrKecamatan" single-line
                                            ...
                                            :disabled="curr_dis_kec" @change="(event) => getWilayah('currkelurahan')"
                                            label="">
                                        </v-autocomplete>
                                ...
                                <v-row class="" no-gutters>
                                    <v-col class="pa-2 martop-min" outlined tile>
                                        ...
                                        <v-autocomplete v-model="searchForm.editCurrKelurahan" single-line
                                            ...
                                            :disabled="curr_dis_kel" @change="(event) => getWilayah('currkelurahan')"
                                            label="">
                                        </v-autocomplete>
...
export default {
    ...
    methods: {
        ...
        editVerification: function () {
            this.$store.commit("main/setLoading", true);
            this.$store
                .dispatch("member/addMemberVerification", {
