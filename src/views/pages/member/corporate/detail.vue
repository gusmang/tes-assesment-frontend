                ...
                <v-dialog
                    ...
                    <template v-slot:default="dialog">
                            <v-card>
                                ...
                                color="success"
                                dark
                                >UnSuspend User Account</v-toolbar>
...
<div style="width:100%;">
    ...
    <v-btn color="success" small outlined @click="showEdit()" v-if="$store.state.member.member.formStates == false && detailsMember.verified == 1"  style="float:right;">
        <!-- <v-icon>mdi-chevron-left</v-icon> -->
        <v-icon>mdi-pencil</v-icon> Edit Data Member
    </v-btn>


    <v-btn color="success" small outlined @click="showListMember()" v-if="$store.state.member.member.formStates == true" style="float:right;">
        <!-- <v-icon>mdi-chevron-left</v-icon> -->
...
<template v-if="$store.state.member.member.formStates == true">
            ...
            <v-col
                ...
                no-gutters>
                 ...
                 <v-row class="" no-gutters>
                    <v-col
                    class="pa-2 martop-min"
                    outlined
                    tile>
                        <v-text-field
                            style="display:none;"
                            v-model="searchForm.editId"
                            label="id"
                            single-line
                            small
                            clearable>
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
                ...
                tile>
                    <v-autocomplete
                            v-model="searchForm.editProvinsi"
                            @change="(event) => getWilayah('kabupaten')"
                            single-line
                            :items="provinsiList"
                            item-text="provinsi"
                            item-value="provinsi"
...
<v-row
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-text-field
                        v-model="searchForm.editBirthPlace"
                        label="Search By BirthPlace"
                        single-line
                        small
                        clearable>
                    </v-text-field>
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
                ...
                tile>
                    <v-autocomplete
                            v-model="searchForm.editKabupaten"
...
<v-row
                ...
                <v-col
                    ...
                    <v-menu
                        ...
                        >
                            <template v-slot:activator="{ on, attrs }">
                            <v-text-field
                                v-model="searchForm.date_of_birth"
                                label="BirthDate"
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
                ...
                tile>
                    <v-autocomplete
                            v-model="searchForm.editKecamatan"
                            :disabled="dis_kec"
                            @change="(event) => getWilayah('kelurahan')"
                            single-line
                            :items="kecamatanList"
                            item-text="kecamatan"
...
<v-row
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-autocomplete
                            v-model="searchForm.editReligion"
                            :items="religion"
                            single-line
                            item-text="text"
                            item-value="value"
    ...
    tile>
        ...
        <v-row class="" no-gutters>
            ...
            tile>
                <v-autocomplete
                    v-model="searchForm.editKelurahan"
                    :disabled="dis_kel"
                    single-line
                    :items="kelurahanList"
                    item-text="kelurahan"
...
<v-row
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
            ...
            tile>
                <v-text-field
                        v-model="searchForm.editAddress"
                        label="Address"
                        single-line
                        small
                        clearable>
...
<v-row
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-autocomplete
                        v-model="searchForm.editBankName"
                        :items="bankList"
                        single-line
                        item-text="bank_name"
                        item-value="bank_id"
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
            ...
            tile>
                <v-text-field
                        v-model="searchForm.editKodePos"
                        label=""
                        single-line
                        small
                        clearable>
...
<v-row
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-text-field
                        v-model="searchForm.editBankAccNo"
                        label=""
                        single-line
                        small
                        clearable>
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
            <v-col
            class="pa-2 font-weight-bold martop-min"
            outlined
            tile>
                ...
                <v-autocomplete
                    v-model="searchForm.editCurrentProvinsi"
                    single-line
                    :items="provinsiList"
                    item-text="provinsi"
                    item-value="provinsi"
                    @change="(event) => getWilayah('currkabupaten')"
                    label="">
                </v-autocomplete>
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-text-field
                        v-model="searchForm.editBankAccHolder"
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
            ...
            tile>
                ...
                <v-autocomplete
                    v-model="searchForm.editCurrKabupaten"
                    :disabled="curr_dis_kab"
                    single-line
                    :items="currkabupatenList"
                    item-text="kabupaten"
                    item-value="kabupaten"
                    @change="(event) => getWilayah('currkecamatan')"
                    label="">
                </v-autocomplete>
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-autocomplete
                        v-model="searchForm.editCurrKecamatan"
                        single-line
                        :items="currkecamatanList"
                        item-text="kecamatan"
                        item-value="kecamatan"
                        :disabled="curr_dis_kec"
                        @change="(event) => getWilayah('currkelurahan')"
                        label="">
                    </v-autocomplete>
    ...
    <v-col
        ...
        <v-row class="" no-gutters>
            ...
            tile>
                ...
                <v-autocomplete
                    v-model="searchForm.editCurrKelurahan"
                    single-line
                    :items="currkelurahanList"
                    item-text="kelurahan"
                    item-value="mix_data"
        ...
        <v-col
            ...
            <v-row class="" no-gutters>
                <v-col
                    ...
                    <v-text-field
                        v-model="searchForm.editBankCurrentAddress"
                        :disabled="curr_dis_addr"
                        label=""
                        single-line
                        small
                        clearable>
...
<v-row no-gutters>
    ...
    <div style="width:100%;">
        ...
        <div style="float:left;">
            <v-btn color="success" small outlined @click="showListMember()" style="float:right;">
                <!-- <v-icon>mdi-chevron-left</v-icon> -->
                <v-icon>mdi-chevron-left</v-icon> Back
            </v-btn>
        </div>
                        ...
                        tile>
                            <v-dialog
                                ...
                                <template v-slot:activator="{ on, attrs }">
                                    ...
                                    v-on="on"
                                    > -->
                                    <img v-bind:src="detailsMember.tab_image" style="width:80px;"  v-bind="attrs"
                                    v-on="on" />
                                    <!-- </v-btn> -->
                                </template>
